...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const filterSection = document.querySelector(".container");
...
// Range inputunu seç
// const rangeInput = document.querySelector(".range-start");
...
//   // İki aralık değerini hesapla
//   let firstRange = value <= 100 ? value : 100;
//   let secondRange = value > 100 ? value : 200;

//   // İki aralık değerini kullanarak istediğiniz işlemleri yapabilirsiniz
//   console.log("İlk aralık:", firstRange);
//   console.log("İkinci aralık:", secondRange);

//   // Örnek: İki aralık değerini bir fonksiyona gönderme
//   // fonksiyon(firstRange, secondRange);
// });
